...
// // initalizations for hart rate sensor
...
// initalize wifi user name and password 
// const char* ssid = "seth0x41";
...
//first parameter is name of access point, second is the password
  res = wm.autoConnect("esp32","12359123"); // password protected ap
